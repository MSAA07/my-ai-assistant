export default {
  ...
  landing: {
    ...
    enterCta: 'Enter',
    heroBadge: 'Early access — free',
    heroHeadline1: 'Your document.',
    heroHeadline2: 'Summaries, flashcards,',
    heroHeadline3: 'and a practice exam.',
    heroSub: 'Upload any study file. Get three revision tools in under a minute.',
    heroCta: 'Start for free',
    heroTrust: 'No credit card · PDF, DOCX, PPTX · English + Arabic',
    credibilityStrip: 'PDF · DOCX · PPTX · English · Arabic · Free during early access',
    problemEyebrow: 'The problem',
    problemHeadline1: 'You have 80 pages to revise.',
    problemHeadline2: 'Your exam is in two days.',
    problemBody: 'Reading through everything once does not make it stick. Making your own notes takes hours. Studymaxing reads your document and builds the three revision tools you actually need — in the time it takes to make a cup of coffee.',
    featuresEyebrow: 'What you get',
    featuresHeadline: 'Three study tools. One upload.',
    feature1Eyebrow: 'Summary',
    feature1Title: 'Your document, structured.',
    feature1Body: 'Key concepts, main arguments, important terms — extracted and organized. Not a generic overview. Built from what you uploaded.',
    feature2Eyebrow: 'Flashcards',
    feature2Title: 'Question and answer, ready to study.',
    feature2Body: 'Cards drawn directly from your content. Study them in the app, or send them to Telegram and study from your phone.',
    feature3Eyebrow: 'Practice Exam',
    feature3Title: 'Test yourself before the real thing.',
    feature3Body: '10 questions generated from your document. Sit the exam, see your score, know what needs more work.',
    howEyebrow: 'How it works',
    howHeadline: 'From document to exam-ready in three steps.',
    step1Title: 'Upload your file',
    step1Body: 'PDF, DOCX, or PPTX. Arabic or English, scanned or typed. Up to 200 pages.',
    step2Title: 'Choose your outputs',
    step2Body: 'Summary, flashcards, exam — or all three at once.',
    step3Title: 'Study from one place',
    step3Body: 'Everything generated lives together in your Study Hub.',
    faqEyebrow: 'Questions',
    faqHeadline: 'Common questions answered.',
    faq1Q: 'Does it work with Arabic documents?',
    faq1A: 'Yes. Arabic is fully supported — including scanned Arabic PDFs processed using OCR. Summaries, flashcards, and exams are generated in the language of your document.',
    faq2Q: 'What file types are supported?',
    faq2A: 'PDF, DOCX, and PPTX files up to 25 MB and 200 pages or slides. Both typed and scanned documents work.',
    ...
    faq5Q: 'Do I need a credit card?',
    faq5A: 'No. Studymaxing is free during early access. No card, no commitment.',
    ...
    tour: {
      ...
      headline: 'From one file to a full study session.',
      sub: 'A student should understand the product in seconds: upload your material, choose what you need, then study the summary, flashcards, and mock exam together.',
      step1Eyebrow: 'Upload',
      step1Title: 'Start with the notes you already have.',
      step1Body: 'Drop in a PDF, DOCX, or PPTX. StudyMaxing reads the document and keeps the original file connected to everything it generates.',
      step2Eyebrow: 'Choose',
      step2Title: 'Pick the study tools you want.',
      step2Body: 'Choose Summary, Flashcards, Mock Exam, or all three. The page makes it clear what each tool does before you generate it.',
      step3Eyebrow: 'Study',
      step3Title: 'Open one Study Hub for everything.',
      step3Body: 'Your summary, recall cards, and practice questions stay together so you know exactly what to read, memorize, and test next.',
      uploadDropTitle: 'Drop your lecture file here',
      uploadDropMeta: 'PDF, DOCX, PPTX · English or Arabic',
      chooseHint: 'All three can be generated from the same file.',
      hubHint: 'Ready in Study Hub',
      summaryOutcome: 'Read the key ideas first.',
      flashcardsOutcome: 'Practice active recall.',
      examOutcome: 'Check exam readiness.'
    },
    mockup: {
      ...
      dashboardEyebrow: 'First upload',
      dashboardTitle: 'Upload your study materials',
      dashboardSubtitle: 'Drop one PDF, DOCX, or PPTX, then choose what StudyMaxing should generate.',
      uploadTitle: 'Biology Midterm.pdf',
      uploadMeta: 'PDF · 18 pages · ready',
      chooseTitle: 'Choose what to generate',
      chooseSubtitle: 'Select the study formats you want before opening Study Hub.',
      summaryTitle: 'Summary',
      summaryText: 'Clear key points from the uploaded file.',
      flashcardsTitle: 'Flashcards',
      flashcardsText: 'Active recall cards from the same source.',
      examTitle: 'Mock Exam',
      examText: '10 practice questions grounded in the document.',
      selected: 'Selected',
      generateSelected: 'Generate selected',
      progressTitle: 'Preparing your study flow',
      progressMeta: 'Summary · Flashcards · Mock Exam',
      progressValue: '72%',
      hubTitle: 'Study Hub',
      hubSubtitle: 'Everything from this document stays together.',
      documentTitle: 'Biology Midterm Pack',
      ready: 'Ready',
      summaryReady: 'Summary ready',
      flashcardsReady: '24 flashcards',
      examReady: '10 questions',
      open: 'Open',
      featureSummaryEyebrow: 'Generated summary',
      ...
      featureFlashcardEyebrow: 'Flashcard · 7 of 24',
      ...
      featureExamEyebrow: 'Question 4 of 10',
