export default {
  ...
  landing: {
    ...
    enterCta: 'Enter',
    heroHeadline1: 'Turn study files',
    heroHeadline2: 'into exam-ready',
    heroHeadline3: 'revision.',
    heroSub: 'Stop rereading pages. Upload your study material and get a focused summary, active-recall flashcards, and a mock exam that shows what to study next.',
    ...
    faqHeadline: 'Questions before you start.',
    ...
    ctaSub: 'Upload your study material and turn it into revision material you can actually use before an exam.',
    ...
    tour: {
      ...
      step1Eyebrow: 'Upload',
      step1Title: 'Start with the study material you already have.',
    ...
    mockup: {
      ...
      flashcardMarkIncorrect: 'Mark incorrect',
      flashcardMarkCorrect: 'Mark correct',
