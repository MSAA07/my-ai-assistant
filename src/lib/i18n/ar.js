export default {
  ...
  home: {
    ...
    uploadSection: {
      ...
      modalDescription: 'Ø£Ø¶Ù Ù…Ù„ÙØ§ØªÙƒ Ù‡Ù†Ø§ØŒ ÙˆÙŠÙ…ÙƒÙ†Ùƒ Ø±ÙØ¹ Ø­ØªÙ‰ 5 Ù…Ù„ÙØ§Øª.',
      dropzoneTitle: 'Ø§Ø³Ø­Ø¨ Ø§Ù„Ù…Ù„Ù(Ø§Øª) Ù„Ø¨Ø¯Ø¡ Ø§Ù„Ø±ÙØ¹',
      dropzoneOr: 'Ø£Ùˆ',
      browse: 'Ø§Ø³ØªØ¹Ø±Ø¶ Ø§Ù„Ù…Ù„ÙØ§Øª',
      supportedFiles: 'ÙŠØ¯Ø¹Ù… ÙÙ‚Ø· Ù…Ù„ÙØ§Øª .pdf Ùˆ .docx Ùˆ .pptx',
