...
const ar = {
  ...
  landing: {
    ...
    enterCta: 'دخول',
    heroHeadline1: 'حوّل ملفاتك الدراسية',
    heroHeadline2: 'إلى مراجعة جاهزة',
    heroHeadline3: 'للاختبار.',
    heroSub: 'توقف عن إعادة قراءة الصفحات. ارفع ملاحظاتك واحصل على ملخص مركز، وبطاقات تذكر نشط، واختبار تجريبي يوضح لك ما تحتاج إلى مراجعته بعد ذلك.',
    heroCta: 'ابدأ المذاكرة',
    problemEyebrow: 'المشكلة',
    problemHeadline1: 'المراجعة كثيرة؟',
    problemHeadline2: 'ابدأ بما يهم.',
    problemBody: 'ارفع ملفك. StudyMaxing يستخرج الأفكار المهمة ويحوّلها إلى ملخص وبطاقات واختبار تدريبي.',
    difference: {
      eyebrow: 'لماذا StudyMaxing',
      headline: 'حزمة دراسة كاملة من موادك أنت.',
      sub: 'ارفع مستندًا واحدًا وراجع بالطريقة التي تناسبك: اقرأ الأفكار الأساسية، تدرّب على الاسترجاع النشط، اختبر نفسك، صدّر موادك، أو أرسل التدريب إلى هاتفك.',
      cards: {
        language: {
          title: 'ادرس بالعربية أو الإنجليزية',
          body: 'ارفع مادة عربية أو إنجليزية واحصل على الملخص والبطاقات والاختبار التدريبي بلغة مستندك.'
        },
        scanned: {
          title: 'يدعم ملفات PDF الممسوحة',
          body: 'استخدم الملفات المكتوبة أو مذكرات المحاضرات الممسوحة ضوئيًا. يقرأ StudyMaxing المحتوى ويحوّله إلى مادة مراجعة منظمة.'
        },
        export: {
          title: 'صدّر حزمة المراجعة',
          body: 'حمّل الملخصات والبطاقات والاختبارات التدريبية كملفات PDF للمراجعة بدون إنترنت أو الطباعة أو المشاركة.'
        },
        telegram: {
          title: 'أرسل التدريب إلى Telegram',
          body: 'أرسل البطاقات والاختبارات التدريبية إلى Telegram لتراجع من هاتفك في أي مكان تدرس فيه.'
        },
        together: {
          title: 'كل شيء يبقى معًا',
          body: 'يبقى الملف الأصلي والملخص والبطاقات والاختبار التجريبي والتقدم في مركز دراسة واحد لذلك المستند.'
        }
      }
    },
    ...
    ctaSub: 'ارفع ملاحظاتك وحوّلها إلى مواد مراجعة يمكنك استخدامها فعلاً قبل الاختبار.',
  ...
  document: {
    ...
    hub: {
      ...
      generatingMessages: {
        ...
        summary: {
          reading: 'نقرأ مستندك…',
          identifying: 'نحدد المفاهيم الأساسية…',
          extracting: 'نستخرج النقاط الرئيسية…',
          writing: 'نكتب ملخصك…'
        },
        flashcards: {
          scanning: 'نبحث عن المصطلحات المهمة…',
          matching: 'نطابق الأسئلة مع الإجابات…',
          building: 'نبني مجموعة البطاقات…',
          organising: 'ننظمها حسب الموضوع…'
        },
        exam: {
          analysing: 'نحلل المحتوى…',
          crafting: 'نصيغ أسئلة الاختبار…',
          trueFalse: 'نضيف أسئلة الصح والخطأ…',
          mixing: 'ننوع أنواع الأسئلة…'
        }
      },
      features: {
        summary: 'الملخص',
      ...
      progress: {
        ...
        featureQueued: 'في قائمة الانتظار بانتظار بدء المعالجة.',
        featureGenerating: 'الإنشاء قيد التشغيل حاليًا.'
      },
      statusTitle: 'دورة حياة المستند',
      statusSubtitle: 'تأتي حالة الاستخراج من دورة حياة المستند، ويجري الإنشاء لكل أداة دراسة على حدة.',
      generationRunning: 'هناك إنشاء لمادة دراسية قيد التنفيذ. سيبقى المحتوى الحالي متاحًا.',
      generationFailed: 'فشلت عملية إنشاء حديثة. يمكنك إعادة المحاولة من أداة الدراسة المناسبة.',
      actionsTitle: 'إجراءات الإنشاء',
      actionsSubtitleEmpty: 'لا توجد مواد دراسية مُنشأة بعد. ابدأ بإنشاء أداة دراسة واحدة أو أكثر.',
      actionsSubtitleExisting: 'أنشئ المزيد أو أعد إنشاء أي أداة دراسة دون مغادرة مساحة العمل هذه.',
      materialsTitle: 'مواد الدراسة'
    },
    source: {
...
ar.landing = {
  ...
  tour: {
    eyebrow: 'جولة المنتج',
    headline: 'من ملف واحد إلى جلسة دراسة كاملة.',
    sub: 'يجب أن يفهم الطالب المنتج خلال ثوانٍ: ارفع المادة، اختر ما تحتاجه، ثم ادرس الملخص والبطاقات والاختبار التجريبي في مكان واحد.',
    step1Eyebrow: 'ارفع',
    step1Title: 'ابدأ بالملاحظات التي لديك بالفعل.',
    step1Body: 'أضف ملف PDF أو DOCX أو PPTX. يقرأ StudyMaxing المستند ويبقي الملف الأصلي مرتبطًا بكل ما يتم إنشاؤه.',
    step2Eyebrow: 'اختر',
    step2Title: 'حدد أدوات الدراسة التي تريدها.',
    step2Body: 'اختر الملخص أو البطاقات التعليمية أو الاختبار التجريبي أو الثلاثة معًا. الصفحة توضّح وظيفة كل أداة قبل إنشائها.',
    step3Eyebrow: 'ادرس',
    step3Title: 'افتح مركز دراسة واحدًا لكل شيء.',
    step3Body: 'يبقى الملخص وبطاقات الاسترجاع وأسئلة التدريب في مكان واحد لتعرف بالضبط ماذا تقرأ وتحفظ وتختبر بعد ذلك.',
    uploadDropTitle: 'اسحب ملف المحاضرة هنا',
    uploadDropMeta: 'PDF أو DOCX أو PPTX · عربي أو إنجليزي',
    chooseHint: 'يمكن إنشاء الأدوات الثلاث من الملف نفسه.',
    hubHint: 'جاهز في مركز الدراسة',
    summaryOutcome: 'اقرأ الأفكار الأساسية أولًا.',
    flashcardsOutcome: 'تدرّب على الاسترجاع النشط.',
    examOutcome: 'اختبر جاهزيتك للامتحان.'
  },
  mockup: {
...
ar.landing = {
  ...
  mockup: {
    ...
    flashcardAnswerLabel: 'الإجابة',
    flashcardMarkIncorrect: 'تحديد كغير صحيح',
    flashcardMarkCorrect: 'تحديد كصحيح',
